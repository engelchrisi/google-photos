...
// running. For testing and running it locally, use localhost.
config.oAuthCallbackPath= '/auth/google/callback';
config.oAuthCallbackUrl = 'http://localhost:8080' + config.oAuthCallbackPath;
...
// where to store the download albums
